...
const config: typescriptUtils.TSESLint.FlatConfig.ConfigArray = [
	...
	},
	{
		...
		rules: {
			...
			"jsdoc/prefer-import-tag": e,
			"jsdoc/reject-any-type": e,
			"jsdoc/reject-function-type": e,
			...
			"jsdoc/require-throws-type": e,
			"jsdoc/require-throws": e,
			"jsdoc/require-yields-check": e,
			"jsdoc/require-yields-type": e,
			"jsdoc/require-yields": e,
			"jsdoc/ts-method-signature-style": [e, "method"],
			"jsdoc/ts-no-empty-object-type": e,
	...
	},
	{
		...
		rules: {
			...
			"stylistic/quotes": [e, "double", {avoidEscape: true, allowTemplateLiterals: "avoidEscape"}],
	...
	},
	{
		...
		rules: {
			...
			"typescript/no-misused-spread": e,
			...
			"typescript/strict-void-return": e,
	...
	},
	{
		...
		rules: {
			...
			"unicorn/consistent-date-clone": e,
			...
			"unicorn/no-unnecessary-array-flat-depth": e,
			"unicorn/no-unnecessary-array-splice-count": e,
			...
			"unicorn/require-module-specifiers": e,
